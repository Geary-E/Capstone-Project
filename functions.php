...
function pageNavbar($conn, $pageName, $name, $userID)
{
    ...
    elseif($pageName=='Opportunities') //Navbar opportunities start
    {
        ...
        <div class="navbar-content-container">
            <div class="navbar"> <!-- Links for each module -->
                ...
                <a href="opportunityComment.php">Manage ' . $pageName . '</a>
            </div>
            <div class="page-content">  <!-- Container for all the content -->
    ...
    elseif($pageName=='OpportunitiesModify') //Navbar for opportunitiesModify start
    {
        ...
        <div class="navbar-content-container">
            ...
            <a href="opportunityComment.php">Manage ' . $pageNameDisplay . '</a>
            </div>
            <div class="page-content">  <!-- Container for all the content -->';
                ...
                opportunityComment($name, $userID, $conn); //Displays the opportunityCreate content
                echo '
            </div>
        </div>';
    ...
    elseif($pageName=='OpportunitiesComments') //Navbar opportunity comment start
    {
        $pageNameDisplay='Opportunities';
        echo '
        <div class="navbar-content-container">
            ...
            <div class="page-content">  <!-- Container for all the content -->';
                opportunitycomment($name, $userID, $conn); //Displays the opportunitityEdit content
                echo '
            </div>
        </div>';
    }// Navbar opportunity comment end
 ...
 * @return void
 */
function opportunityComment($name, $userID, $conn)
{
    echo '
    <div class="modify-opportunities">
    <h1>Hello <span>' . $name . '</span> this is the opportunity comment section</h1>
